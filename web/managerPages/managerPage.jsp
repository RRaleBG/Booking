...
<div class="container-fluid w-75 mt-3">
    ...
    <c:forEach var="hot" items="${listaHotela}">
        <div class="card card-deck bg-glass m-1 rounded-3" style="display:inline-block;">
            ...
            <div class="card-footer border-0 flex justify-content-arround mt-1">	       
                <a class="btn btn-outline-info btn-sm shadow" href="<%= request.getContextPath()%>/userPages/roomsFromHotel.jsp?idHotel=${hot.idHotel}">Rooms</a>
                <a class="btn btn-outline-warning btn-sm shadow ml-5" href="<%= request.getContextPath()%>/managerPages/editHotel.jsp?idHotel=${hot.idHotel}">Edit hotel</a>
                <a class="btn btn-outline-danger btn-sm shadow ml-5" href="<%= request.getContextPath()%>/managerPages/deleteHotel.jsp?idHotel=${hot.idHotel}">Delete</a>
            </div>
        </div>
    </c:forEach> 
</div>
