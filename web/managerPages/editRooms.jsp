...
<div class="container mt-3 py-3">  
    ...
    <div class="card bg-glass py-4 justify-content-center">
        <form action="../EditRoom" method="POST" enctype="multipart/form-data" class="needs-validation m-0" novalidate>
            ...
            <div class="row justify-content-center">
                ...
                <div class="row col-md-10 justify-content-center text-center">
                    ...
                    <div class="form-outline col-md-2 text-center mb-3">
                        <input type="text" name="name" readonly value="${hotel.name}" id="form3Example1" class="form-control form-control-sm border-0 bg-glass bg-transparent text-white-50 fw-semibold text-center " required autofocus/>
                        <label class="form-label text-white-50" for="form3Example1">Hotel name</label>
                    </div>
                    <!-- Room Id -->
                    <div class="form-outline col-md-2 text-center mb-3">
			   ...
			   <label class="form-check-label text-white-50" for="flexSwitchCheckDefault">Smoking</label>
                        ...
                        <!-- BALKON -->
                        <div class="form-check form-switch text-center mb-2 col-md-2">
                    ...
                    <div class="row col-md-8 justify-content-center">
                        <!-- Upload image input-->
                        <div class="input-group mb-2 rounded-pill w-75">
                ...
                <!-- Button  -->
                <div class="row col-md-6 justify-content-center text-center pt-2 pb-2 mt-3 rounded-pill w-75">
